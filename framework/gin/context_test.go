...
import (
	...
	"github.com/luoshengyue/coreDemo/framework/gin/binding"
	"github.com/golang/protobuf/proto"
	"github.com/stretchr/testify/assert"

	testdata "github.com/luoshengyue/coreDemo/framework/gin/testdata/protoexample"
)
...
func TestContextHandlerName(t *testing.T) {
	...
	assert.Regexp(t, "^(.*/vendor/)?github.com/luoshengyue/coreDemo/framework/gin.handlerNameTest$", c.HandlerName())
}
